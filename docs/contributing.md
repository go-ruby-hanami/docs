...
Contributions are welcome. `go-ruby-hanami/hanami` is built to a small set of
...
The library is in [`github.com/go-ruby-hanami/hanami`](https://github.com/go-ruby-hanami/hanami).
This documentation site is in [`github.com/go-ruby-hanami/docs`](https://github.com/go-ruby-hanami/docs).

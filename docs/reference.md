...
The public API lives at the module root (`github.com/go-ruby-hanami/hanami`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `hanami`, while the surface follows
...
```go
import "github.com/go-ruby-hanami/hanami"
```
...
- **[pkg.go.dev/github.com/go-ruby-hanami/hanami](https://pkg.go.dev/github.com/go-ruby-hanami/hanami)**

The module's [README](https://github.com/go-ruby-hanami/hanami#readme) carries worked
